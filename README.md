...
The current implementation is an OpenTUI/Bun rewrite inspired by `gh-dash` and `atlas.nvim`.
...
This rewrite targets Bitbucket Cloud first. Bitbucket Data Center support is not implemented in the OpenTUI UI yet.
